...
<form action = "login_process.php" method="post">
	...
	?>
	<br/>
	<input type="checkbox" name="expire" value="3600" checked/>账号仅保存一个小时，请注意时间！
	<br/>
	<br/>
	<p align="center"><input type="submit" class="btn btn-default" style="background:#6699ff" value="登录"/><p>
</form>
